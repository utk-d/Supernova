...
const About = () => {
  return (
    <div className='lg:h-[52vh] lg:w-[92%] flex relative lg:left-[7.6vh] md:left-[4vh] lg:bg-[#DFDDC3] md:h-[42.3vh] md:w-[91%] sm:h-[35vh]' id='about-us'>
      <div id='about-text' className=' tab:h-[45vh] tab:w-[45vh] lg:w-[40vw] lg:h-[50vh] md:w-[65vw] md:h-[40vw] sm:w-[50vh] relative sm:top-[4vw] md:top-[0vw] md:left-[0vw] sm:left-[3vw] text-left lg:flex-col '>
        <div id='about-text-data' className='lg:h-[20vh] tab:h-[20vh] tab:w-[65vw] lg:w-[73vh] font-tomorrow relative lg:top-[8vh] md:top-[6vh] flex flex-col lg:left-0 gap-4 '>
        ...
        <div id='shop-wp-buttons' className='tab:w-[30vw] text-[#494209] tab:text-[1.28vw] font-montserrat h-[5.6vh] relative lg:top-[15vh] md:w-[40vw] md:top-[10vh] lg:flex lg:flex-row md:flex md:flex-row justify-between sm:top-[6vw] sm:flex sm:justify-start sm:gap-[6vw] md:gap-[4vw]  '>
