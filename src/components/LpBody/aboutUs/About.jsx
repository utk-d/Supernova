...
const About = () => {
  return (
    <div className='h-[48vh] w-[92%] flex relative left-[7.6vh]' id='about-us'>
      <div id='about-text' className='w-[40vw] h-[50vh]'>
        ...
        justify-between'>
            <button className='border-2 border-[#767676] w-[10vw] h-[100%] flex items-center justify-center hover:bg-[#494209] hover:text-[#ece9bb] shadow-xl shadow-[#c9c994] transition-all ease-in'>Shop <img width="24" height="24" src="https://img.icons8.com/material-rounded/24/expand-arrow--v1.png" alt="expand-arrow--v1"/></button>
