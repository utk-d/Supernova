...
const About = () => {
  return (
    <div className='lg:h-[52vh] lg:w-[92%] flex relative lg:left-[7.6vh] md:left-[4vh] md:bg-red-300 lg:bg-[#DFDDC3] md:h-[42.3vh] md:w-[91%]' id='about-us'>
      <div id='about-text' className='lg:w-[40vw] lg:h-[50vh] md:w-[65vw] md:h-[40vw] lg:text-left lg:flex-col '>
        ...
        <div id='shop-wp-buttons' className='tab:w-[25vw] text-[#494209] tab:text-[1.28vw] font-montserrat h-[5.6vh] relative lg:top-[15vh] md:w-[40vw] md:top-[10vh] lg:flex lg:flex-row md:flex md:flex-row justify-between'>
            <button className='border-2 border-[#767676] tab:w-[10vw] tab:h-[100%] flex gap-1 items-center justify-center hover:bg-[#494209] hover:text-[#ece9bb] shadow-xl shadow-[#c9c994] transition-all ease-in md:w-[18vw] md:h-[80%]'>Shop <img width="24" height="24" src="https://img.icons8.com/material-rounded/24/expand-arrow--v1.png" alt="expand-arrow--v1"/></button>
            <button className='border-2 border-[#767676] tab:w-[12vw] tab:h-[100%] flex gap-4 items-center justify-center hover:bg-[#494209] hover:text-[#ece9bb] shadow-xl shadow-[#c9c994] transition-all ease-in md:w-[18vw] md:h-[80%]'>Whatsapp<img width="24" height="24" src="https://img.icons8.com/ios-filled/50/whatsapp--v1.png" alt="whatsapp--v1"/></button>
      </div>
      </div>
    </div>
  )
