...
const AboutImg = () => {
  return (
    <div id='img-cont' className='lg:flex md:hidden items-end absolute left-[32.8vw] top-[9vw]'>
      ...
      <div id='img-1' className='bg-white h-[38vh] w-[17vw] bottom-[3vw] z-[1] '><img src="../public/image 2.png" alt="" /></div>
    </div>
  )
}
